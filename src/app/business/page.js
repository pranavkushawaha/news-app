...
const Page = function () {
  ...
  useEffect(() => {
    (async function (uri) {
      ...
      "https://newsapi.org/v2/top-headlines?country=in&category=business&apiKey=da8df51c1a2f49a68113ee7f70a9ccdc"
    );
  }, []);
      ...
      {loading ? (
        ...
        <div className="flex flex-col items-center">
          <div className="bg-white w-1/2 mt-4  p-4 rounded-xl drop-shadow-xl flex justify-between items-center">
            <p className="text-3xl font-semibold text-gray-700">Business News</p>
